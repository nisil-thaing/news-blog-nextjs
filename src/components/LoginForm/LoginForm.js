...
import { LoadingWrapper } from 'components/AuthenticationDialog/AuthenticationDialog.style';
...
function LoginForm ({ isLoading, onSwitchToRegistrationForm, onSubmit }) {
  return <Container className="p-2 pl-md-4 pr-md-4">
    <h1 className="mb-5 text-center">Log in</h1>
    {
      isLoading
        ? <LoadingWrapper>
          <i className="d-block ml-auto mr-auto text-secondary bi bi-arrow-repeat" />
        </LoadingWrapper>
        : <>
          <div className="row">
